...
import { IncrementWeekAction, DecrementWeekAction } from '../../../../redux/actions/weekActions';
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return bindActionCreators({ IncrementWeekAction, DecrementWeekAction }, dispatch);
};
